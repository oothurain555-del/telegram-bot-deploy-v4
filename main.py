...
# ---------------- AI CORE ----------------
async def ai_all_in_one(text: str, mode: str = "search") -> str:
    import aiohttp
...
def register_handlers(app: Application):
    ...
    app.add_handler(CommandHandler("filterlist", filterlist_command))
    app.add_handler(CommandHandler("emfilter", emptyfilter_command))
    app.add_handler(CommandHandler("emptyfilter", emptyfilter_command))
    app.add_handler(CommandHandler("name", name_command))
    app.add_handler(CommandHandler("emptyname", emptyname_command))
    app.add_handler(CommandHandler("add_reply", add_reply_command))
